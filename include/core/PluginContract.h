...
namespace core {
    ...
    // ==============================================================================
    // SERVICE LOCATOR & INTERFACE IDS (v0.3.0 Standard)
    // ==============================================================================
    using SystemID = uint64_t;

    // Резервируем ID для базовых систем движка (Legacy Support)
    ...
    // ==============================================================================
    // ЧИСТЫЕ C-ИНТЕРФЕЙСЫ (Стабильный ABI без vtable)
    // ==============================================================================
    ...
    // Интерфейс для новой распределенной системы ассетов
    struct AssetAPI {
    ...
    // ==============================================================================
    // УНИВЕРСАЛЬНЫЙ КОНТЕКСТ ЯДРА (Материнская плата движка v0.3.0)
    // ==============================================================================
    struct EngineContext {
        ...
        // Legacy API секция (Для обратной совместимости с плагинами v0.2.0)
        InputAPI* input;
        AudioAPI* audio;
        RenderAPI* renderer;

        // Service Locator v0.3.0 (Динамическая регистрация служб)
        // ИСПРАВЛЕНО: Строгие скобки указателей на функции (*get_system) и (*register_system)
...
// ==============================================================================
// ЭКСПОРТ ТОЧКИ ВХОДА (C-Linkage) - Вынесен наружу namespace
// ==============================================================================
#ifdef __cplusplus
extern "C" {
#endif
